...
local affixesByTier = {
		Minor = {
			...
			{name = "Mod_LOW_BhaalAmulet_Passive", type = "Passive", category = "Utility", tier = "Minor", tags = {"Phys"}, duration = -1},
    ...
    -- Add more minor affixes here
		...
		Medium = {
			...
			{name = "Mod_Shout_GoadingRoar_Bear_Summon", type = "Ability", category = "Utility", tier = "Medium", tags = {"Barb", "Fighter", "Gish", "Pala"}, duration = -1},	
		...
		Major = {
			...
			{name = "Land_Coast", type = "Passive", category = "Defense", tier = "Major", tags = {"Mag"}, duration = -1},			
			{name = "Land_Desert", type = "Passive", category = "Defense", tier = "Major", tags = {"Mag"}, duration = -1},			
			{name = "Land_Desert_2", type = "Passive", category = "Utility", tier = "Major", tags = {"Mag"}, duration = -1},			
			{name = "Land_Mountain", type = "Passive", category = "Defense", tier = "Major", tags = {"Mag"}, duration = -1},			
			{name = "Land_Mountain_2", type = "Passive", category = "Damage", tier = "Major", tags = {"Mag"}, duration = -1},			
			{name = "Land_Swamp", type = "Passive", category = "Utility", tier = "Major", tags = {"Mag"}, duration = -1},			
			{name = "Land_Swamp_2", type = "Passive", category = "Damage", tier = "Major", tags = {"Mag"}, duration = -1},			
			{name = "Land_Underdark", type = "Passive", category = "Utility", tier = "Major", tags = {"Mag"}, duration = -1},			
			{name = "Land_Underdark_2", type = "Passive", category = "Utility", tier = "Major", tags = {"Mag"}, duration = -1},			
			...
			{name = "MOD_INFERNAL_CLEAVING", type = "Status", category = "Damage", tier = "Major", tags = {"Phys"}, duration = -1},					
			...
			{name = "MOD_CONFUSION_RAT", type = "Status", category = "Defense", tier = "Major", tags = {"Gen"}, duration = -1},			
			...
			{name = "Mod_MAG_Blindside_Shortsword_Passive", type = "Passive", category = "Damage", tier = "Major", tags = {"Gen"}, duration = -1},			
...
local absolutistArchetypes = {
    Phys = {
		...
		{ name = "MercilessPhys", affixes = {"MOD_MERCILESS", "Alert", "Mod_Last_Stand"} },
    ...
    Barb = {
		...
		{ name = "Predator", affixes = {"Mod_Extra_Reaction_Passive", "Mod_Opportune_Predator", "Mod_Shout_GoadingRoar_Bear_Summon"} },
    ...
    Fighter = {
		...
		{ name = "TheTank", affixes = {"Parry", "MAG_DEFENDER_WEAPON_ENCHANTMENT_TECHNICAL", "Mod_Shout_GoadingRoar_Bear_Summon"} },
		...
		{ name = "Taunter", affixes = {"MOD_WILD_MAGIC_BARBARIAN_PROTECTIVE_LIGHTS", "Mod_Shout_GoadingRoar_Bear_Summon", "Mod_GoadingAttack"} },
    ...
    Pala = {
		...
		{ name = "Challenger", affixes = {"Mod_Warders_Empathy", "MAG_DEFENDER_WEAPON_ENCHANTMENT_TECHNICAL", "Mod_Shout_GoadingRoar_Bear_Summon"} },
